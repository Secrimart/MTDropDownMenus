...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MTDropDownMenus.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rstx_reg@aliyun.com/MTDropDownMenus'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rstx_reg@aliyun.com' => 'secrimart@aliyun.com' }
  s.source           = { :git => 'https://github.com/rstx_reg@aliyun.com/MTDropDownMenus.git', :tag => s.version.to_s }
